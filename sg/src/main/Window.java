...
public class Window extends JFrame implements Runnable, Cloneable {

	public static Level[] l = new Level[30];
	...
	private void update(){
		...
		{
			State.currentState.update(KeyBoard.command);
		}
